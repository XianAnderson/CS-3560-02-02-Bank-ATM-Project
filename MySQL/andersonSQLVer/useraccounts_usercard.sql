...
CREATE TABLE `usercard` (
  ...
  `cardType` enum('debit','credit') COLLATE utf8mb4_unicode_ci NOT NULL,
  `cardNumber` char(16) COLLATE utf8mb4_unicode_ci NOT NULL,
  `expirationDate` date NOT NULL,
  `securityCode` char(3) COLLATE utf8mb4_unicode_ci NOT NULL,
  `pin` char(4) COLLATE utf8mb4_unicode_ci NOT NULL,
  `transactions` json DEFAULT NULL,
  PRIMARY KEY (`cardID`),
  KEY `accountID_idx` (`accountID`),
  CONSTRAINT `accountID` FOREIGN KEY (`accountID`) REFERENCES `useraccount` (`accountID`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `usercard` VALUES (1,1,'debit','1234567812345678','2026-12-31','123','4321','[1]');
