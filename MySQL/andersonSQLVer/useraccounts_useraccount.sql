...
CREATE TABLE `useraccount` (
  ...
  `checkingBalance` decimal(15,2) DEFAULT '0.00',
  `savingsBalance` decimal(15,2) DEFAULT '0.00',
  `creditLine` decimal(15,2) DEFAULT '0.00',
  `cardID` int DEFAULT NULL,
  PRIMARY KEY (`accountID`),
  KEY `fk_cardID` (`cardID`),
  CONSTRAINT `fk_cardID` FOREIGN KEY (`cardID`) REFERENCES `usercard` (`cardID`) ON DELETE SET NULL ON UPDATE CASCADE
...
INSERT INTO `useraccount` VALUES (1,'Jane Doe','123 Main St, Cityville','555-1234','2024-11-01','debit',1500.00,3000.00,500.00,1);
